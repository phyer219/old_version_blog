...
\begin{align}
-v_{\mathrm{eff}} = -v + (-v) \sum_{\vec{k}} \sum_{\omega'}
    \left(-G(\frac{\omega}{2}+\omega', \frac{\vec{k}}{2})\right)
   \left(-G(\frac{\omega}{2}-\omega', -\frac{\vec{k}}{2})\right)
   \left(-v_{\mathrm{eff}}\right)
\end{align}
中间格林函数部分可以求得
\begin{align}
&\sum_{\vec{k}}\sum_{\omega'} \frac{1}{\mathrm{i}(\frac{\omega}{2} + \omega') - \frac{k^2}{8m}}
\frac{1}{\mathrm{i}(\frac{\omega}{2} - \omega') - \frac{k^2}{8m}} \\
=&\sum_{\vec{k}}\sum_{\omega'} \left[\frac{1}{\mathrm{i}(\frac{\omega}{2} + \omega') - \frac{k^2}{8m}}
 +\frac{1}{\mathrm{i}(\frac{\omega}{2} - \omega') - \frac{k^2}{8m}}\right] 
 \frac{1}{\mathrm{i}\omega - \frac{k^2}{4m}}\\
=& \sum_{\vec{k}} \frac{n(\frac{k^2}{8m}) + n(\frac{k^2}{8m})}{\mathrm{i}\omega - \frac{k^2}{4m}}
\end{align}
